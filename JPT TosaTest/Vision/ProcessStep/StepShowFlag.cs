...
namespace JPT_TosaTest.Vision.ProcessStep
{
    public class StepShowFlag : VisionProcessStepBase
    {
        ...
        public override bool Process()
        {
            ...
            //利用参考线画出原来画的区域
            HOperatorSet.ReadRegion(out HObject OldRegion, In_RegionFullPathFileName);

            HalconVision.Instance.GetGeometryRegionBy2Lines(OldRegion, TupleList[0].Item1, TupleList[0].Item2, TupleList[0].Item3, TupleList[0].Item4,
