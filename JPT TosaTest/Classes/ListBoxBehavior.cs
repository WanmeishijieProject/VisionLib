...
namespace JPT_TosaTest.Classes
{
    ...
    {
        static readonly Dictionary<ListBoxEdit, Capture> Associations =
               new Dictionary<ListBoxEdit, Capture>();
        ...
        {
            var listBox = (ListBoxEdit)sender;
            if (Associations.ContainsKey(listBox))
                Associations[listBox].Dispose();
