...
namespace VisionLib.CommonVisionStep
{
    public class StepShowFlag : VisionProcessStepBase
    {
        ...
        /// 垂直参考线
        /// </summary>
        public Tuple<HTuple, HTuple, HTuple, HTuple> In_VLine { get; set; }

        /// <summary>
        /// 水平参考线
        /// </summary>
        public Tuple<HTuple, HTuple, HTuple, HTuple> In_HLine { get; set; }
        ...
        public override bool Process()
        {
            ...
            List<VisionLineData> TupleList = new List<VisionLineData>();
            TupleList.Add(new VisionLineData(In_VLine.Item1,In_VLine.Item2,In_VLine.Item3,In_VLine.Item4));
            TupleList.Add(new VisionLineData(In_HLine.Item1, In_HLine.Item2, In_HLine.Item3, In_HLine.Item4));
            ...
            HalconVision.Instance.GetGeometryRegionBy2Lines(OldRegion, In_VLine.Item1, In_VLine.Item2, In_VLine.Item3, In_VLine.Item4,
                                    In_HLine.Item1, In_HLine.Item2, In_HLine.Item3, In_HLine.Item4, GeometryPose, out HObject NewRegion);
